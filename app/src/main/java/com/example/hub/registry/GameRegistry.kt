...
object GameRegistry {
    ...
    const val APPLE_WORM_ID = "apple_worm"
    const val HELIX_JUMP_ID = "helix_jump"
    const val COLOR_MAZE_3D_ID = "color_maze_3d"
    const val SAND_LOOP_ID = "sand_loop"
    const val WOODTURNING_ID = "woodturning"
    const val DOODLE_JUMP_ID = "doodle_jump"
    const val TOMB_OF_THE_MASK_ID = "tomb_of_the_mask"
    const val CROSSY_ROAD_ID = "crossy_road"
    const val PAPER_IO_2_ID = "paper_io_2"
    const val HOLE_IO_ID = "hole_io"
    const val SEA_BATTLE_2_ID = "sea_battle_2"
    const val IQ_BOOST_ID = "iq_boost"
    const val BALL_GUYS_ID = "ball_guys"
    ...
    private val gamesList: List<GameInfo> = listOf(
        ...
        GameInfo(
            id = APPLE_WORM_ID,
            name = "Apple Worm",
            description = "Navigate a stretchy worm, eat apples to grow longer, and crawl into the warp portal.",
            longDescription = "A clever physics puzzle! Guide your bendable worm across floating platforms and deep chasms. Munch tasty apples to lengthen your body, climb over hurdles, and slip safely into the vortex portal.",
            category = GameCategory.PUZZLE,
            version = "1.0",
            isAvailable = true,
            isFeatured = false,
            ...
            entryRoute = "appleworm_game",
            order = 20,
            totalLevelsEstimate = "Multi-level",
            difficultyEstimate = "Clever Puzzle"
        ),
        GameInfo(
            id = HELIX_JUMP_ID,
            name = "Helix Jump",
            description = "Rotate the spiral helix tower to drop the bouncing ball down through the gaps.",
            longDescription = "An exhilarating arcade descent! Drag horizontally to spin the vibrant 3D helix column, navigate through platform openings, rack up combo drops, and dodge dangerous red hazard segments.",
            category = GameCategory.ARCADE,
            version = "1.0",
            isAvailable = true,
            isFeatured = false,
            ...
            entryRoute = "helixjump_game",
            order = 21,
            totalLevelsEstimate = "Continuous",
            difficultyEstimate = "Fast Reflex"
        ),
        GameInfo(
            id = COLOR_MAZE_3D_ID,
            name = "Color Maze 3D",
            description = "Roll the paint sponge through the labyrinth and splash vibrant colors on every floor tile.",
            longDescription = "Satisfying color splatter maze! Swipe to roll your colorful sponge block through intricate maze passages, coating every uncolored tile with glossy paint until the entire labyrinth shines.",
            category = GameCategory.PUZZLE,
            version = "1.0",
            isAvailable = true,
            isFeatured = false,
            ...
            entryRoute = "colormaze3d_game",
            order = 22,
            totalLevelsEstimate = "Multi-level",
            difficultyEstimate = "Casual"
        ),
        GameInfo(
            id = SAND_LOOP_ID,
            name = "Sand Loop",
            description = "Loop moving sand streams, combine primary colors, and guide them into color bins.",
            longDescription = "Hypnotic kinetic physics simulator! Connect dynamic loop pipes to blend red, blue, and yellow sand streams into rich vibrant mixtures and fill collector canisters.",
            category = GameCategory.CASUAL,
            version = "1.0",
            isAvailable = true,
            isFeatured = false,
            ...
            entryRoute = "sandloop_game",
            order = 23,
            totalLevelsEstimate = "Continuous",
            difficultyEstimate = "Soothing"
        ),
        GameInfo(
            id = WOODTURNING_ID,
            name = "Woodturning 3D",
            description = "Carve spinning wooden blocks with precision chisels into stunning sculpted artifacts.",
            longDescription = "Ultra-satisfying lathe workshop simulation! Touch and carve along the spinning wood piece to match the target silhouette, watch realistic wood chips fly, and buff your masterpiece to a sparkling shine.",
            category = GameCategory.CASUAL,
            version = "1.0",
            isAvailable = true,
            isFeatured = false,
            ...
            entryRoute = "woodturning_game",
            order = 24,
            totalLevelsEstimate = "Multi-level",
            difficultyEstimate = "Creative"
        ),
        GameInfo(
            id = DOODLE_JUMP_ID,
            name = "Doodle Jump",
            description = "Bounce continuously on moving, fragile, and spring platforms into the stratosphere.",
            longDescription = "The iconic jumping classic on graph paper! Guide your adorable bouncy jumper across static, shifting, and breaking platforms, launch from super springs, and climb higher and higher into the skies.",
            category = GameCategory.ARCADE,
            version = "1.0",
            isAvailable = true,
            isFeatured = false,
            ...
            entryRoute = "doodlejump_game",
            order = 25,
            totalLevelsEstimate = "Endless",
            difficultyEstimate = "Agility"
        ),
        GameInfo(
            id = TOMB_OF_THE_MASK_ID,
            name = "Tomb of the Mask",
            description = "Dash instantly along neon tomb walls, collect glowing dots, and dodge deadly spikes.",
            longDescription = "Fast-paced neon labyrinth rush! Swipe in 4 directions to propel your ancient golden mask from wall to wall, leave a luminous trail, collect gold relics, and evade hazardous spike traps.",
            category = GameCategory.ARCADE,
            version = "1.0",
            isAvailable = true,
            isFeatured = false,
            ...
            entryRoute = "tombofthemask_game",
            order = 26,
            totalLevelsEstimate = "Chamber Levels",
            difficultyEstimate = "Fast Pace"
        ),
        GameInfo(
            id = CROSSY_ROAD_ID,
            name = "Crossy Road",
            description = "Hop across busy highways, rushing rivers on logs, and high-speed train tracks.",
            longDescription = "Voxel hopper endless adventure! Time your hops across roaring multilane traffic, balance on floating logs down the river, watch for flashing train warning lights, and see how far you can travel.",
            category = GameCategory.ARCADE,
            version = "1.0",
            isAvailable = true,
            isFeatured = false,
            ...
            isComingSoon = false,
            primaryColor = Color(0xFFFF9800),
            secondaryColor = Color(0xFF1E2832),
            accentColor = Color(0xFFE53935),
            entryRoute = "crossyroad_game",
            order = 27,
            totalLevelsEstimate = "Endless",
            difficultyEstimate = "Timing & Focus"
        ),
        GameInfo(
            id = PAPER_IO_2_ID,
            name = "Paper.io 2",
            description = "Conquer territory in a smooth arena, draw loops to claim land, and eliminate rivals.",
            longDescription = "Territory conquest arena battle! Venture outside your home base to draw ribbon loops and claim vast territories, but protect your tail: if rival bots sever your line, you get eliminated!",
            category = GameCategory.STRATEGY,
            version = "1.0",
            isAvailable = true,
            isFeatured = false,
            ...
            isComingSoon = false,
            primaryColor = Color(0xFF00E5FF),
            secondaryColor = Color(0xFF101726),
            accentColor = Color(0xFFFF1744),
            entryRoute = "paperio2_game",
            order = 28,
            totalLevelsEstimate = "Arena Battles",
            difficultyEstimate = "Tactical"
        ),
        GameInfo(
            id = HOLE_IO_ID,
            name = "Hole.io",
            description = "Control a growing black hole, consume city objects, and become the biggest vortex.",
            longDescription = "Eat everything in sight! Drag your void black hole through city streets, swallowing street cones, trees, parked cars, and towering skyscrapers as your vortex grows in diameter against AI rivals.",
            category = GameCategory.ARCADE,
            version = "1.0",
            isAvailable = true,
            isFeatured = false,
            ...
            secondaryColor = Color(0xFF0F172A),
            accentColor = Color(0xFFFFD166),
            entryRoute = "holeio_game",
            order = 29,
            totalLevelsEstimate = "60s Rounds",
            difficultyEstimate = "Fun & Fast"
        ),
        GameInfo(
            id = SEA_BATTLE_2_ID,
            name = "Sea Battle 2",
            description = "Deploy your naval armada on blueprint grid paper and sink the enemy fleet.",
            longDescription = "Classic battleship naval warfare on graph paper! Position your aircraft carrier, cruisers, destroyers, and submarines, call artillery strikes on enemy coordinates, and outsmart the tactical AI commander.",
            ...
            secondaryColor = Color(0xFF0F1E33),
            accentColor = Color(0xFFE63946),
            entryRoute = "seabattle2_game",
            order = 30,
            totalLevelsEstimate = "Naval War",
            difficultyEstimate = "Strategy"
        ),
        GameInfo(
            id = IQ_BOOST_ID,
            name = "IQ Boost",
            description = "Train your brain across memory matrices, speed math, Stroop tests, and reflex speed.",
            longDescription = "Comprehensive cognitive workout! Sharpen your mental faculties across 5 neuro-training mini-challenges testing visual memory, rapid arithmetic, perceptual Stroop focus, and sub-millisecond reaction reflexes.",
            category = GameCategory.LOGIC,
            version = "1.0",
            isAvailable = true,
            isFeatured = false,
            isNew = true,
            isComingSoon = false,
            primaryColor = Color(0xFF72EFDD),
            secondaryColor = Color(0xFF1E1E38),
            accentColor = Color(0xFFFFD166),
            entryRoute = "iqboost_game",
            order = 31,
            totalLevelsEstimate = "Daily Brain Tests",
            difficultyEstimate = "Mind Sharpening"
        ),
        GameInfo(
            id = BALL_GUYS_ID,
            name = "Ball Guys: Merge Party",
            description = "Aim, drop, and merge cute matching ball guys to evolve the legendary King Ball.",
            longDescription = "Delightful fruit-style ball merging party! Aim your drop from the overhead claw, fuse identical ball guys to evolve bigger expressive characters, keep the container from overflowing, and reach the crowning King Ball!",
            category = GameCategory.PUZZLE,
            version = "1.0",
            isAvailable = true,
            isFeatured = false,
            ...
            secondaryColor = Color(0xFF2B1D3A),
            accentColor = Color(0xFFFF1744),
            entryRoute = "ballguys_game",
            order = 32,
            totalLevelsEstimate = "Endless Party",
            difficultyEstimate = "Chill & Addictive"
        ),
        GameInfo(
            id = BALL_SORT_ID,
